        	...
        	<div class="nx-info-wrap">
                <div class="nx-info-desc" style="width: 100%;">
                	...
                	<div class="nx-admin-row">
                        <div class="col-1-2" style="padding-left: 0px; margin-left: 0px; width: 60%;">
                        	<h2 style="margin: 12px 0px;"><?php esc_html_e('I-EXCEL Setup Guide', 'i-excel'); ?></h4>
                        ...
                        <div class="col-1-2" style="padding-right: 0px; margin-right: 0px; width: 36%;">            	
							<div>
                            	<ul class="setup-list">
                                	<li><b><?php esc_html_e('0:03','i-excel'); ?> </b><?php esc_html_e('Installing TemplatesNext Toolkit', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('0:36','i-excel'); ?> </b><?php esc_html_e('Setting-up Top Menu', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('1:08','i-excel'); ?> </b><?php esc_html_e('Highlighting A Menu Item', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('1:49','i-excel'); ?> </b><?php esc_html_e('Adding Logo', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('2:58','i-excel'); ?> </b><?php esc_html_e('Maintenance/Coming Soon Mode', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('4:17','i-excel'); ?> </b><?php esc_html_e('Blog/Shop Page Settings', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('5.07','i-excel'); ?> </b><?php esc_html_e('Theme Slider', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('6:03','i-excel'); ?> </b><?php esc_html_e('Topbar Customization', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('6:53','i-excel'); ?> </b><?php esc_html_e('Header Customization', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('7:42','i-excel'); ?> </b><?php esc_html_e('Creating A Front Page', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('15:03','i-excel'); ?> </b><?php esc_html_e('Setting A Page As Your Front/Home Page', 'i-excel'); ?></li>
                                	<li><b><?php esc_html_e('15:34','i-excel'); ?> </b><?php esc_html_e('A Preview : Premium Theme I-SPIRIT', 'i-excel'); ?></li>
                                </ul>
                            </div> 
				...
				?> 
                	<div class="nx-tab-content">
                        ...
                        <ul class="nx-welcome">
  							<?php
									echo '<li>';
									echo '<h3>';
									printf( esc_html__( 'Select Header Style', 'i-excel' ));
									echo '</h3>';
									printf( esc_html__( 'Select a header design for your website.', 'i-excel' ) );
                    ...
                    <div>
                        ...
                        <a href="<?php echo $page_settings_url; ?>" class="nx-colorbox"><?php echo esc_html__('Ideal Static Front Page Settings.', 'i-excel'); ?></a>
                        </h3>
                    	<h3 style="margin: 16px 0px 6px 0px;">
                        <a href="<?php echo $page_settings_url_2; ?>" class="nx-colorbox"><?php echo esc_html__('Ideal Page Settings For Page Builders Using Full Width Layout.', 'i-excel'); ?></a>
                        </h3>
                	...
                	<div class="nx-tab-content"> 
                        ...
                        <div class="popup" id="media-popup">
                        	<div class="nx-videowrapper">
                                ...
                                <div class="clvideo"><a href="#"><?php esc_html_e('Close Video', 'i-excel'); ?></a></div>
                            </div>
                        </div>                       
						<div class="tx-wspace-12"></div>
        			</div>      
