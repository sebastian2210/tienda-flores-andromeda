...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'i-excel' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'i-excel' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'i-excel' ),
			'200'       => esc_html__( 'Light 200', 'i-excel' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'i-excel' ),
			'300'       => esc_html__( 'Book 300', 'i-excel' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'i-excel' ),
			'400'       => esc_html__( 'Normal 400', 'i-excel' ),
			'regular'   => esc_html__( 'Normal 400', 'i-excel' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'i-excel' ),
			'500'       => esc_html__( 'Medium 500', 'i-excel' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'i-excel' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'i-excel' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'i-excel' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'i-excel' ),
			'700'       => esc_html__( 'Bold 700', 'i-excel' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'i-excel' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'i-excel' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'i-excel' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'i-excel' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'i-excel' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'i-excel' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'i-excel' ),
		);
	}
