...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'i-excel' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'i-excel' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'i-excel' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'i-excel' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'i-excel' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'i-excel' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'i-excel' ); ?>',
} );
#>
