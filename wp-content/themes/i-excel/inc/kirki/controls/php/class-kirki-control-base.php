	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'i-excel' ),
				'remove'               => esc_html__( 'Remove', 'i-excel' ),
				'default'              => esc_html__( 'Default', 'i-excel' ),
				'selectFile'           => esc_html__( 'Select File', 'i-excel' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'i-excel' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'i-excel' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'i-excel' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'i-excel' ),
			)
		);
