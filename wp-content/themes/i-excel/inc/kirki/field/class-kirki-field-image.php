...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'i-excel' ),
				'change'       => esc_html__( 'Change image', 'i-excel' ),
				'default'      => esc_html__( 'Default', 'i-excel' ),
				'remove'       => esc_html__( 'Remove', 'i-excel' ),
				'placeholder'  => esc_html__( 'No image selected', 'i-excel' ),
				'frame_title'  => esc_html__( 'Select image', 'i-excel' ),
				'frame_button' => esc_html__( 'Choose image', 'i-excel' ),
			)
		);
	}
