...
function iexcel_import_files() {
  return array(
		...
		array(
		  ...
		  'import_file_url'            		=> 'http://wp-demos.com/downloads/demos/i-excel/elementor/elementor-slider.xml',
		  //'import_widget_file_url'     		=> 'http://wp-demos.com/downloads/demos/i-excel/elementor/personal.wie',
		  'import_customizer_file_url' 		=> 'http://wp-demos.com/downloads/demos/i-excel/elementor/elementor-slider.dat',
		  'import_preview_image_url'     	=> trailingslashit( get_template_directory_uri() ) . 'inc/txoc/small-images/elementor-slider.jpg',
		  'import_notice'                	=> __( 'This process involves transfer of data and media from server to server and might take some time.', 'i-excel' ),
		  'preview_url'                		=> 'http://www.wp-demos.com/i-spirit/i-excel-elementor-slider/',
		  'required_plugin'					=> array(
												'elementor',
												'contact-form-7',
											),
