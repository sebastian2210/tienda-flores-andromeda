...
function iexcel_ibanner_slider () {    
	...
	$slides_preset = array (
        array(
            ...
            'itrans_slide_desc' => esc_attr__( 'Do not gamble on the future, act now, without delay.', 'i-excel' ),
            'itrans_slide_linktext' => esc_attr__( 'Know More', 'i-excel' ),
            'itrans_slide_linkurl' => esc_url('http://www.templatesnext.org/i-excel/?ref=ie-slide'),
            'itrans_slide_image' => esc_url( get_template_directory_uri() . '/images/slides/slide-1.jpg' ),
        ),
        array(
            'itrans_slide_title' => esc_attr__( 'Never Bend Your Head. Always Hold It High. ', 'i-excel' ),
            'itrans_slide_desc' => esc_attr__( 'When you have a dream, you hve got to grab it and never let go.', 'i-excel' ),
            'itrans_slide_linktext' => esc_attr__( 'Know More', 'i-excel' ),
            'itrans_slide_linkurl' => esc_url('http://www.wp-demos.com/'),
        ...
        array(
            ...
            'itrans_slide_desc' => esc_attr__( 'When you have a dream, you hve got to grab it and never let go.', 'i-excel' ),
            'itrans_slide_linktext' => esc_attr__( 'Know More', 'i-excel' ),
            'itrans_slide_linkurl' => esc_url('http://www.google.com/'),
	...
	if( count( $arrslidestxt) > 0 ){
		...
		echo '	<div id="da-slider" class="da-slider" role="banner" data-slider-transition="'.$slider_transition.'" data-slider-speed="'.$sliderscpeed.'" data-slider-height="'.$slider_height.'" data-slider-reduct="'.$slider_reduct.'" data-slider-parallax="'.$itrans_sliderparallax.'">';
