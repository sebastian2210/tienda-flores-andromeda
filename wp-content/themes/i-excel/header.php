...
<body <?php body_class(); ?> style=" <?php echo $bg_style; ?> ">
	...
	<div id="page" class="hfeed site">
    	...
    	<div id="utilitybar" class="utilitybar <?php echo $topbar_bg_class; ?> <?php echo esc_attr($ubar_class); ?>">
        	<div class="ubarinnerwrap">
                ...
                <div class="topphone tx-topmail">
                    ...
                    <?php if( $clickable_phnem ) : ?>
                        <?php echo '<a href="mailto:'.sanitize_email($top_email).'" target="_blank">'.sanitize_email($top_email).'</a>'; ?>
                    <?php else : ?>
